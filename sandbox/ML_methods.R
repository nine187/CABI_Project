...
pred <- load_var(path="/Documents/future_climate_scenarios/CSIRO_raster/A1B/CM10_2030_A1B_CS_Bio_ASCII_V1.2$ 
",categorical = NULL, format = ".tif", Norm = TRUE, verbose = TRUE,GUI = FALSE)
plot(pred)

#load the species data, lat and long??
occ <- load_occ(path="GitHub/CABI_Project/data/",Env = pred_hist,
